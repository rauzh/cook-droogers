...
insert into users (name, email, password, type) values ('five-manager', 'five@ppo.ru', '123123', 1);
...
insert into users (name, email, password, type) values ('kekart', 'kekart@ppo.ru', '123', 2);