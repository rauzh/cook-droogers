...
type AddManagerParams struct {
	...
	/*Данные для создания менеджера
	  Required: true
	  In: body
	*/
	ManagerData *models.CreateManagerDTO
}
...
func (o *AddManagerParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("managerData", "body", ""))
			} else {
				res = append(res, errors.NewParseError("managerData", "body", "", err))
			}
		} else {
