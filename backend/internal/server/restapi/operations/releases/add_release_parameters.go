...
type AddReleaseParams struct {
	...
	/*Информация о релизе
	  ...
	  In: body
	*/
	Release *models.UploadReleaseDTO
}
...
func (o *AddReleaseParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UploadReleaseDTO
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("release", "body", ""))
			} else {
				res = append(res, errors.NewParseError("release", "body", "", err))
			}
		} else {
