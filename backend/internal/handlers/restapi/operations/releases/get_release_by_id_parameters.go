...
//
// To ensure default values, the struct must have been initialized with NewGetReleaseByIDParams() beforehand.
func (o *GetReleaseByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error

	o.HTTPRequest = r

	rReleaseID, rhkReleaseID, _ := route.Params.GetOK("release_id")
...
// bindReleaseID binds and validates parameter ReleaseID from path.
func (o *GetReleaseByIDParams) bindReleaseID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	...
	if err != nil {
		return errors.InvalidType("release_id", "path", "uint64", raw)
	}
	o.ReleaseID = value
