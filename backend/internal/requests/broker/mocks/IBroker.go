...
func (_m *IBroker) AddHandler(topics []string, handler broker.IConsumerGroupHandler) error {
	ret := _m.Called(topics, handler)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func([]string, broker.IConsumerGroupHandler) error); ok {
		r0 = rf(topics, handler)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *IBroker_AddHandler_Call) Return(_a0 error) *IBroker_AddHandler_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *IBroker_AddHandler_Call) RunAndReturn(run func([]string, broker.IConsumerGroupHandler) error) *IBroker_AddHandler_Call {
	_c.Call.Return(run)
	return _c
}
