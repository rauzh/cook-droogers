...
func (_m *TrackRepo) Create(_a0 *models.Track) (uint64, error) {
	ret := _m.Called(_a0)
	...
	var r0 uint64
	var r1 error
	if rf, ok := ret.Get(0).(func(*models.Track) (uint64, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(*models.Track) uint64); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(uint64)
	}
...
//   - _a0 *models.Track
func (_e *TrackRepo_Expecter) Create(_a0 interface{}) *TrackRepo_Create_Call {
	return &TrackRepo_Create_Call{Call: _e.mock.On("Create", _a0)}
}

func (_c *TrackRepo_Create_Call) Run(run func(_a0 *models.Track)) *TrackRepo_Create_Call {
...
func (_c *TrackRepo_Create_Call) RunAndReturn(run func(*models.Track) (uint64, error)) *TrackRepo_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: _a0
func (_m *TrackRepo) Get(_a0 uint64) (*models.Track, error) {
	ret := _m.Called(_a0)
	...
	var r0 *models.Track
	var r1 error
	if rf, ok := ret.Get(0).(func(uint64) (*models.Track, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(uint64) *models.Track); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
//   - _a0 uint64
func (_e *TrackRepo_Expecter) Get(_a0 interface{}) *TrackRepo_Get_Call {
	return &TrackRepo_Get_Call{Call: _e.mock.On("Get", _a0)}
}

func (_c *TrackRepo_Get_Call) Run(run func(_a0 uint64)) *TrackRepo_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uint64))
	})
	return _c
...
func (_c *TrackRepo_Get_Call) RunAndReturn(run func(uint64) (*models.Track, error)) *TrackRepo_Get_Call {
	_c.Call.Return(run)
	return _c
}
