...
func (_m *ManagerRepo) Create(_a0 *models.Manager) error {
	ret := _m.Called(_a0)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*models.Manager) error); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Error(0)
	}
...
//   - _a0 *models.Manager
func (_e *ManagerRepo_Expecter) Create(_a0 interface{}) *ManagerRepo_Create_Call {
	return &ManagerRepo_Create_Call{Call: _e.mock.On("Create", _a0)}
}

func (_c *ManagerRepo_Create_Call) Run(run func(_a0 *models.Manager)) *ManagerRepo_Create_Call {
...
func (_c *ManagerRepo_Create_Call) RunAndReturn(run func(*models.Manager) error) *ManagerRepo_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: _a0
func (_m *ManagerRepo) Get(_a0 uint64) (*models.Manager, error) {
	ret := _m.Called(_a0)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(uint64) (*models.Manager, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(uint64) *models.Manager); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
//   - _a0 uint64
func (_e *ManagerRepo_Expecter) Get(_a0 interface{}) *ManagerRepo_Get_Call {
	return &ManagerRepo_Get_Call{Call: _e.mock.On("Get", _a0)}
}

func (_c *ManagerRepo_Get_Call) Run(run func(_a0 uint64)) *ManagerRepo_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(uint64))
	})
	return _c
...
func (_c *ManagerRepo_Get_Call) RunAndReturn(run func(uint64) (*models.Manager, error)) *ManagerRepo_Get_Call {
	_c.Call.Return(run)
	return _c
}

// GetRandManagerID provides a mock function with given fields:
func (_m *ManagerRepo) GetRandManagerID() (uint64, error) {
	ret := _m.Called()
...
func (_e *ManagerRepo_Expecter) GetRandManagerID() *ManagerRepo_GetRandManagerID_Call {
	return &ManagerRepo_GetRandManagerID_Call{Call: _e.mock.On("GetRandManagerID")}
}

func (_c *ManagerRepo_GetRandManagerID_Call) Run(run func()) *ManagerRepo_GetRandManagerID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ManagerRepo_GetRandManagerID_Call) RunAndReturn(run func() (uint64, error)) *ManagerRepo_GetRandManagerID_Call {
	_c.Call.Return(run)
	return _c
}
